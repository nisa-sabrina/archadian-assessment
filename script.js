  ...
  reader.onload = function(e) {
    ...
    workbook.SheetNames.forEach(function(sheetName) {
      ...
      var edi =
        ...
        $("#recv_code").val() +
        "+" +
        get_date_str(dt, "daterawonly") +
        ":" +
        get_date_str(dt, "timetominrawonly") +
        "+" +
        refno +
        "'\n";
      ...
      for (singleRow = 0; singleRow < allRows.length; singleRow++) {
        if (typeof allRows[singleRow] != "undefined") {
          ...
          if (singleRow > 7) {
            ...
            //rowCells[3] //5 - F, 4 - E
            let fe = "5";
            if (typeof rowCells[3] != "undefined" && rowCells[3] == "E")
              fe = "4";
            //2 TS - N, 6 TS - Y
            let type = "2";
            if (typeof rowCells[11] != "undefined" && rowCells[11] == "Y")
              type = "6";

            if (
              typeof rowCells[1] != "undefined" &&
              typeof rowCells[7] != "undefined"
            ) {
              edi +=
                "EQD+CN+" +
                rowCells[1] +
            ...
            if (typeof rowCells[6] != "undefined") {
            ...
            if (typeof rowCells[19] != "undefined") {
              edi += "LOC+9+" + rowCells[19] + ":139:6'\n";
              line++;
            }
            if (typeof rowCells[13] != "undefined") {
              edi += "MEA+AAE+VGM+KGM:" + rowCells[13] + "'\n";
              line++;
            }
            if (
              typeof rowCells[17] != "undefined" &&
              $.trim(rowCells[17]) != "" &&
              $.trim(rowCells[17]) != "/"
            ) {
            ...
            if (typeof rowCells[8] != "undefined") {
              edi += "FTX+AAI+++" + rowCells[8] + "'\n";
              line++;
            }

            if (
              typeof rowCells[12] != "undefined" &&
              $.trim(rowCells[12]) != "" &&
              $.trim(rowCells[12]) != "/"
            ) {
